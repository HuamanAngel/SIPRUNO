...
<body>
    ...
    <main class="container custom-content-central">
        ...
        <div class="d-flex justify-content-end">
            <a href="<?php echo "http://".$_SERVER['SERVER_NAME'].'/Capa_Logica/ShowCitas.php'; ?>" class="btn-verde">Ver mis citas</a>
        </div>
        <p class="text-center">
        ...
        <div class="class-grid-now-3">
            ...
            <div class="">
                <img class="img-thumbnail" src="<?php echo "http://".$_SERVER['SERVER_NAME'].'/src/assets/profile_doctor.jpg'?>" alt="">
                <form action="<?php echo "http://".$_SERVER['SERVER_NAME']."/Capa_Logica/RegisterCita.php"; ?>" method="POST">
